            ...
            <div className='desktop'>
                ...
                <div className='md:block hidden'>
                    ...
                    <div className="relative w-72 ml-4 mb-3 mt-4">
                        <div
                            className={`flex items-center justify-between border-b  px-3 py-1 cursor-pointer ${isproductopen1 ? 'border-black' : 'border-gray-300'}`}
                            ...
                            <div className="border-b border-gray-300 bg-white z-10">
                                <div className="flex flex-col py-2 px-3">
                                    <div className="flex items-center mb-2">
                                        ...
                                        <label htmlFor="mens" className='ml-2 text-gray-700'>Causal</label>
                                    </div>
                                    <div className="flex items-center mb-2">
                                        <input type="checkbox" id="womens" className='w-4 h-4' />
                                        <label htmlFor="womens" className='ml-2 text-gray-700'>Kurta Pajama</label>
                                    </div>
                                    <div className="flex items-center mb-2">
                                        <input type="checkbox" id="fragrances" className='w-4 h-4' />
                                        <label htmlFor="fragrances" className='ml-2 text-gray-700'>shalwar kameez</label>
                                    </div>
                                    <div className="flex items-center mb-2">
                                        <input type="checkbox" id="fragrances" className='w-4 h-4' />
                                        <label htmlFor="fragrances" className='ml-2 text-gray-700'>T-shirts</label>
                                    </div>
                    ...
                    <div className="relative w-72 ml-4 mb-3 mt-4">
                        <div
                            className={`flex items-center justify-between border-b  px-3 py-1 cursor-pointer ${isproductopen ? 'border-black' : 'border-gray-300'}`}
                    ...
                    <div className="relative w-72 ml-4 mb-3">
                        <div
                            className={`flex items-center justify-between border-b  px-3 py-1 cursor-pointer ${issizeopen ? 'border-black' : ''}`}
                    ...
                    <div className="relative w-72 ml-4 mb-3 mt-4">
                        <div
                            className={`flex items-center justify-between border-b  px-3 py-1 cursor-pointer ${iscoloropen ? 'border-black' : 'border-gray-300'}`}
                        ...
                        {iscoloropen && (
                            <div className="border-b border-gray-300 bg-white z-10">
                                <div className="flex flex-col py-2 px-3">
                                    <div className="flex items-center mb-2">
                                        <input type="checkbox" id="mens" className='w-4 h-4' />
                                        <label htmlFor="mens" className='ml-2 text-gray-700'>Red</label>
                                    </div>
                                    <div className="flex items-center mb-2">
                                        <input type="checkbox" id="womens" className='w-4 h-4' />
                                        <label htmlFor="womens" className='ml-2 text-gray-700'>Kurta Pajama</label>
                    ...
                    <Button
                        type="submit"
                        className="w-32 ml-16 mb-4 mt-4"
